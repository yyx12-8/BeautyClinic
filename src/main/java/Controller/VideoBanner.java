...
@WebServlet("/videoBannerProDetail")
public class VideoBanner extends HttpServlet {
    @Override
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        List<Map<String, Object>> sqlByCon = commonSelect.findSqlByCon("select * from bannerlist where banner_id = #{con}", bannerId);
        sqlSession.commit();
        if(sqlByCon.size() != 0){
