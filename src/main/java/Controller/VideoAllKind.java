...
@WebServlet(urlPatterns = "/videoKindList")
public class VideoAllKind extends HttpServlet {
    @Override
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        List<Map<String, Object>> sql = commonSelect.findSql("select * from cliniclist");
        sqlSession.commit();
        if(sql.size() != 0){
